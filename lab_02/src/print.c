...
void print_menu(void)
{
    printf("\n"
           ...
           "5  - Show table key by count people\n"
           "6  - Show sort table key by count people (bubble sort)\n"
           "7  - Show sort table key by count people (quick sort)\n"
           "8  - Show sort table by count people (bubble sort)\n"
           "9  - Show sort table by count people (quick sort)\n"
           "10 - Show sort table by count people by keys (bubble sort)\n"
           "11 - Show sort table by count people by keys (quick sort)\n"
